...
const DrawerHeader = ({ navigation }) => {
    ...
    console.log(user_Info,"sjdsnsdiyuibh");
  return (
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <View style={styles.iconContainer}>
            ...
            <View style={{ width: 20 }} />
            <Text style={styles.btntxt}>{user_Info?.cashback_points}</Text>
          </View>
        </View>
      </View>
    </View>
    ...
    return (
      <TouchableOpacity
        style={{
          ...
          backgroundColor: index == selectIndex ? Colors.lightgreen2 : Colors.White,
        }}
        onPress={() => {
